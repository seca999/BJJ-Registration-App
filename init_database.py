"""
BJJ Academy Management System - Local Database Initializer
Creates SQLite database and populates all tables with dummy/seed data.
Location: C:\BJJ Academy\bjj_academy.db
"""
...
DB_DIR = r"C:\BJJ Academy\Database"
DB_PATH = os.path.join(DB_DIR, "bjj_academy.db")
...
CREATE TABLE members (
  ...
  classes_remaining INTEGER NOT NULL DEFAULT 10,
...
VALUES
('coach-lucas', 'Lucas Silva', 'Professor Lucas', 'Head Professor & Academy Founder', 'Black', 3, 'lucas.silva@artesuave.bjj', '(555) 299-8801', '["Adults Gi", "Advanced Sparring", "No-Gi Submission Grappling"]', 'per_class', 55.00, 10, 3.00, 1, '2020-01-15', '3rd Degree Black Belt under Master Carlson Gracie lineage. 2x Pan American Gold Medalist with 16 years teaching experience.'),
('coach-marcos', 'Marcos Oliveira', 'Coach Marcos', 'Youth Program Director & Fundamentals Coach', 'Brown', 2, 'marcos.oliveira@artesuave.bjj', '(555) 344-9922', '["Kids BJJ", "Teens BJJ", "Youth Bullyproof", "Mat Discipline"]', 'per_class', 45.00, 8, 2.50, 1, '2022-03-01', 'Brown Belt instructor specializing in youth motor development, balance, and discipline.'),
...
('mem-4', 'Sophia Rossi', 'sophia.rossi@outlook.com', '(555) 567-8901', 'Adults', 'White', 3, 'class_pack', 10, 2, '2024-01-15', '2024-07-15', 'warning', 'Both', '2023-10-01', 24, '2024-03-02', 'Marco Rossi', '(555) 567-0000', 'Brother'),
('mem-5', 'Zain Al-Khatib', 'zain.bjj@gmail.com', '(555) 678-9012', 'Kids', 'Grey', 2, 'class_pack', 10, 8, '2024-02-10', '2024-08-10', 'active', 'Gi', '2023-11-12', 14, '2024-02-27', 'Tariq Al-Khatib', '(555) 678-1111', 'Father');
...
('pay-4', 'mem-4', 'Sophia Rossi', 150.00, '$', '2024-01-15', '18:45:00', 'Credit Card', '10 Class Punch Card', 10, 'RCP-2024-004', 'Completed'),
('pay-5', 'mem-5', 'Zain Al-Khatib', 150.00, '$', '2024-02-10', '16:00:00', 'Cash', '10 Class Youth Punch Card', 10, 'RCP-2024-005', 'Completed');
...
('att-3', 'mem-3', 'Maya Lin', 'Blue', 0, '2024-03-02', '11:15:00', 'Saturday', 'cls-teens-bjj', 'Teens BJJ (Ages 16-17)', 'Teens', 'Marcos Oliveira', 'coach-marcos', -1),
('att-4', 'mem-4', 'Sophia Rossi', 'White', 3, '2024-03-02', '12:00:00', 'Saturday', 'cls-adults-gi', 'Adults BJJ (Gi & Sparring)', 'Adults', 'Lucas Silva', 'coach-lucas', 2);
...
def initialize_bjj_database():
    print("=" * 60)
    print("🥋 BJJ Academy Database Initializer")
    print("=" * 60)

    # 1. Ensure directory exists
    print(f"\n[1/3] Ensuring directory exists at: '{DB_DIR}'...")
    os.makedirs(DB_DIR, exist_ok=True)
    print(f"      Directory confirmed: {DB_DIR}")

    # 2. Connect to SQLite
    print(f"\n[2/3] Connecting to SQLite database at: '{DB_PATH}'...")
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()

    # 3. Execute Schema & Seed Script
    print("\n[3/3] Creating tables, views, indexes, and inserting dummy data...")
    cursor.executescript(SQL_SCHEMA_AND_SEED)
    conn.commit()
    ...
    tables_to_check = [
        ...
        "timetable_slots",
        "timetable_cells",
        "timetable_board_config",
    ]

    print("\n" + "-" * 60)
    print("📊 DATABASE SUMMARY & ROW COUNTS:")
    print("-" * 60)
    ...
    print("\n" + "=" * 60)
    print("✅ SUCCESS! Database created and populated successfully.")
    print(f"📁 Database File Location: {DB_PATH}")
    print("=" * 60)


if __name__ == "__main__":
    initialize_bjj_database()
